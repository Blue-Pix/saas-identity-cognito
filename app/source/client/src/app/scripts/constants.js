...
angular.module('clientApp')
  .constant('Constants', {
    ...
    AUTH_MANAGER_URL: 'http://DOMAIN_URL',
    USER_MANAGER_URL: 'http://DOMAIN_URL',
    TENANT_MANAGER_URL: 'http://DOMAIN_URL',
    TENANT_REGISTRATION_URL: 'http://DOMAIN_URL',
    PRODUCT_MANAGER_URL: 'http://DOMAIN_URL',
    ORDER_MANAGER_URL: 'http://DOMAIN_URL',
    SYSTEM_REGISTRATION_URL: 'http://DOMAIN_URL',
